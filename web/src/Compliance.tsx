...
export type RegTab =
  | "overview" | "process" | "services" | "approvals" | "ops" | "risk" | "assess" | "controls" | "coverage" | "changes" | "graph";

export const REG_TABS: RegTab[] =
  ["overview", "process", "services", "risk", "approvals", "ops", "assess", "controls", "coverage", "changes", "graph"];
